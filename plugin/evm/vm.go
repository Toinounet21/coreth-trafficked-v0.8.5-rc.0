...
import (
	...
	coreth "github.com/Toinounet21/coreth-trafficked-v0.8.5-rc.0/chain"
	"github.com/Toinounet21/coreth-trafficked-v0.8.5-rc.0/consensus/dummy"
	"github.com/Toinounet21/coreth-trafficked-v0.8.5-rc.0/core"
	"github.com/Toinounet21/coreth-trafficked-v0.8.5-rc.0/core/state"
	"github.com/Toinounet21/coreth-trafficked-v0.8.5-rc.0/core/types"
	"github.com/Toinounet21/coreth-trafficked-v0.8.5-rc.0/eth/ethconfig"
	"github.com/Toinounet21/coreth-trafficked-v0.8.5-rc.0/metrics/prometheus"
	"github.com/Toinounet21/coreth-trafficked-v0.8.5-rc.0/node"
	"github.com/Toinounet21/coreth-trafficked-v0.8.5-rc.0/params"
	"github.com/Toinounet21/coreth-trafficked-v0.8.5-rc.0/rpc"
	...
	// inside of cmd/geth.
	_ "github.com/Toinounet21/coreth-trafficked-v0.8.5-rc.0/eth/tracers/js"
	_ "github.com/Toinounet21/coreth-trafficked-v0.8.5-rc.0/eth/tracers/native"
	...
	"github.com/Toinounet21/avalanchego-trafficked-v1.7.4/cache"
	...
	"github.com/Toinounet21/avalanchego-trafficked-v1.7.4/database/manager"
	"github.com/Toinounet21/avalanchego-trafficked-v1.7.4/database/prefixdb"
	"github.com/Toinounet21/avalanchego-trafficked-v1.7.4/database/versiondb"
	...
	"github.com/Toinounet21/avalanchego-trafficked-v1.7.4/utils/crypto"
	"github.com/Toinounet21/avalanchego-trafficked-v1.7.4/utils/formatting"
	"github.com/Toinounet21/avalanchego-trafficked-v1.7.4/utils/logging"
	"github.com/Toinounet21/avalanchego-trafficked-v1.7.4/utils/math"
	"github.com/Toinounet21/avalanchego-trafficked-v1.7.4/utils/perms"
	"github.com/Toinounet21/avalanchego-trafficked-v1.7.4/utils/profiler"
	"github.com/Toinounet21/avalanchego-trafficked-v1.7.4/utils/timer/mockable"
	"github.com/Toinounet21/avalanchego-trafficked-v1.7.4/version"
	"github.com/Toinounet21/avalanchego-trafficked-v1.7.4/vms/components/avax"
	"github.com/Toinounet21/avalanchego-trafficked-v1.7.4/vms/components/chain"
	"github.com/Toinounet21/avalanchego-trafficked-v1.7.4/vms/secp256k1fx"

	commonEng "github.com/Toinounet21/avalanchego-trafficked-v1.7.4/snow/engine/common"

	avalancheJSON "github.com/Toinounet21/avalanchego-trafficked-v1.7.4/utils/json"
)
