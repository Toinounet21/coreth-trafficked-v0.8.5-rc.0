...
go build -ldflags "-X github.com/Toinounet21/coreth-trafficked-v0.8.5-rc.0/plugin/evm.GitCommit=$coreth_commit -X github.com/Toinounet21/coreth-trafficked-v0.8.5-rc.0/plugin/evm.Version=$coreth_version" -o "$binary_path" "plugin/"*.go
